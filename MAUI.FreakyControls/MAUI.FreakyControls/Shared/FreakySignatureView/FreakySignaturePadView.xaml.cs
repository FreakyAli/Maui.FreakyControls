...
public partial class FreakySignaturePadView : ContentView
{
    ...
    /// <summary>
    ///     Create an encoded image of the currently drawn signature at the specified size with the specified stroke and
    ///     background colors.
    /// </summary>
    ...
    /// <summary>
    ///     Create an encoded image of the currently drawn signature at the specified scale with the specified stroke and
    ///     background colors.
    /// </summary>
    public Task<Stream> GetImageStreamAsync(SignatureImageFormat format, Color strokeColor, Color fillColor,
    ...
    {
        get => (Assembly)GetValue(ClearImageAssemblyProperty);
