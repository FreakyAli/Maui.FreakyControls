...
using NativeCardRenderer = Maui.FreakyControls.Platforms.Android.CardsViewRenderer;
#endif
#if MACCATALYST
using NativeCardRenderer= Maui.FreakyControls.Platforms.MacCatalyst.CardsViewRenderer;
#endif
#if IOS
using Maui.FreakyControls.Platforms.iOS;
using NativeCardRenderer = Maui.FreakyControls.Platforms.iOS.CardsViewRenderer;
#endif
#if IOS || MACCATALYST
...
public static class Extensions
{
    ...
    public static void AddFreakyHandlers(this IMauiHandlersCollection handlers)
    {
        ...
        handlers.AddHandler(typeof(CardsView), typeof(NativeCardRenderer));
    }
