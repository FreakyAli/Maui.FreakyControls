...
public class AndroidAutoSuggestBox : AppCompatAutoCompleteTextView
{
    private bool suppressTextChangedEvent;
    private Func<object, string> textFunc;
    private readonly SuggestCompleteAdapter adapter;
    ...
    {
        var nativeColor = color.ToPlatform();
        this.SetTextColor(nativeColor);
    }
    ...
    {
        var nativeColor = color.ToPlatform();
        this.SetHintTextColor(nativeColor);
    }
