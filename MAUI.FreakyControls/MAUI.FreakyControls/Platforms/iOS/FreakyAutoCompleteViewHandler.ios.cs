...
{
    protected override AutoCompleteTextField CreatePlatformView()
    {
    ...
    protected override void ConnectHandler(AutoCompleteTextField platformView)
    {
    ...
    protected override void DisconnectHandler(AutoCompleteTextField platformView)
    {
        PlatformView.EditingChanged -= PlatformView_TextChanged;
        PlatformView.EditingDidBegin -= PlatformView_EditingDidBegin;
        PlatformView.EditingDidEndOnExit -= PlatformView_EditingDidEndOnExit;
    ...
    {
        var ctrl = UIApplication.SharedApplication.GetCurrentViewController();
...
public class AutoCompleteTextField : MauiTextField, IUITextFieldDelegate
{
    ...
    public void Draw(UIViewController viewController, CALayer layer, FreakyAutoCompleteView virtualView, NFloat x, NFloat y)
    {
        ...
        {
            var e = (virtualView.FindInParent<ScrollView>());
            var p = e.Padding;
            var m = e.Margin;
